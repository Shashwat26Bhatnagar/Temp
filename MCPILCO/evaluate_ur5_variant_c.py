"""
Evaluation script for MC-PILCO UR5 Variant C training results.

Usage:
    python evaluate_ur5_variant_c.py                         # uses results_ur5_variant_c_5/1/log.pkl
    python evaluate_ur5_variant_c.py -log .../log.pkl
...
Includes a 3D animation of the UR5 arm using MuJoCo forward kinematics to
compute body positions at each timestep.
"""
...
# CLI
# -----------------------------------------------------------------------
p = argparse.ArgumentParser("evaluate_ur5_variant_c")
p.add_argument("-log", default="results_ur5_variant_c_5/1/log.pkl")
p.add_argument("-save", default="results_ur5_variant_c_5/1/plots")
...
fig.suptitle("UR5 Variant C - policy optimisation cost per trial",
...
# -----------------------------------------------------------------------
print("\n" + "=" * 78)
print("EVALUATION SUMMARY — MC-PILCO UR5 Variant C")
print("=" * 78)
