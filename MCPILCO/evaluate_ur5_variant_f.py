"""
Evaluation script for MC-PILCO UR5 Variant F (reverse KL with tight sigma) results.

Usage:
    python evaluate_ur5_variant_f.py                         # uses results_ur5_variant_f_5/1/log.pkl
    python evaluate_ur5_variant_f.py -log .../log.pkl
    python evaluate_ur5_variant_f.py -no_anim                # skip GIF (faster)
...
Cost is REVERSE KL on fitted Gaussian moments with tight target sigma
(0.05 rad / 0.20 rad/s), plus chance-constraint slack on joint positions.
This is the apples-to-apples reverse-KL counterpart of Variants D (W2)
and E (forward KL).
"""
...
# CLI
# -----------------------------------------------------------------------
p = argparse.ArgumentParser("evaluate_ur5_variant_f")
p.add_argument("-log", default="results_ur5_variant_f_5/1/log.pkl")
p.add_argument("-save", default="results_ur5_variant_f_5/1/plots")
...
fig.suptitle("UR5 Variant F - policy optimisation cost per trial",
...
# -----------------------------------------------------------------------
print("\n" + "=" * 78)
print("EVALUATION SUMMARY — MC-PILCO UR5 Variant F")
print("=" * 78)
